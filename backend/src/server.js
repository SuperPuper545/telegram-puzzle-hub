...
app.get('/api/me', authMiddleware, (req, res) => {
  ...
  res.json({
    user: {
      ...
      equippedBirdSkin: userRecord.equipped_bird_skin || 'bird_classic',
      equippedStackSkin: userRecord.equipped_stack_skin || 'stack_classic',
      equippedKnifeSkin: userRecord.equipped_knife_skin || 'knife_classic',
    },
    scores: scoresMap,
